...
export default async function LocaleLayout({
  ...
  return (
    <html lang={locale} suppressHydrationWarning>
      <body
        className="relative flex justify-center items-center w-full h-dvh overflow-x-clip"
      ...
      >
        ...
        >
          <NextIntlClientProvider messages={messages}>
            <div className="flex flex-col-reverse md:flex-row justify-start items-center w-full h-full">
              <TooltipProvider>
                <Header />
                <main className="w-full h-[calc(100vh-65px)] md:h-full overflow-y-scroll scrollbar">
